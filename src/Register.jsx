...
const Register = () => {
  ...
  return (
    <div className="flex flex-col justify-center md:p-[30px] p-[0px] rounded-[10px] align-center w-[100vh] overflow-hidden overflow-y-auto md:w-[50%] lg:w-[40%] bg-black md:bg-[var(--primary-color)] gap-[20px] my-[40px]">
