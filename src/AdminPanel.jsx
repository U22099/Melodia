...
function AdminPanel(props) {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col bg-black rounded-xl p-[20px] dialog md:w-[60vw] w-[95vw] justify-start items-start gap-[10px] h-[80vh] overflow-y-scroll scrollbar py-[10px]">
                        ...
                        {props.users.sort((a, b) => a.username.localeCompare(b.username)).map((x, i) => (
                            <li key={i}>
                                <div className="cursor-pointer p-[10px] rounded-[10px] flex gap-[20px] items-center">
                                    ...
                                    <div className="max-w-[80%] overflow-wrap">
