...
function AdminPanel(props) {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col bg-black rounded-xl p-[20px] dialog md:w-[60vw] w-[95vw] justify-center items-center gap-[10px] h-[80vh] overflow-y-scroll scrollbar py-[10px]">
