...
function AdminPanel(props) {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col bg-black rounded-xl p-[20px] dialog md:w-[60vw] w-[95vw] justify-center items-center gap-[10px] min-h-[80vh] overflow-y-scroll scrollbar py-[10px]">
                        ...
                        {props.users.sort((a, b) => a.username.localeCompare(b.username)).map((x, i) => (
                            <li key={i}>
                                <div className="cursor-pointer p-[10px] rounded-[10px] flex gap-[20px] items-center">
                                    ...
                                    <div className="w-[80%]">
                                        <h1 className="text-[1.8em] bold md:text-[2.2em] font-[serif]">{x.username}</h1>
                                        <p>Email: {x.email}</p>
                                    </div>
                                </div>
                            </li>
