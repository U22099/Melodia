            ...
            jsmediatags.read(file, {
                onSuccess: async (tag) => {
                    const result = {
                        ...
                        "image": (tag.tags.picture ? await toBase64(new Blob([new Uint8Array(tag.tags.picture.data)], {type: tag.tags.picture.format})) : await toBase64(new Blob([atob(image.split(',')[1]), {type: image.split(',')[0]}))
                    }
                    console.log(result);
                    resolve(result);
                },
