        ...
        return (
            <motion.div
                ...
                <div className="flex w-[100%] mx-auto gap-[10px]">
                    <button className="w-[50%] bg-green-600 rounded-md text-[2em] shadow-[2px_2px_5px_3px_rgba(0,0,0,0.5)]" onClick={() => ans(true)}>Yes</button>
                    <button className="w-[50%] bg-red-600 rounded-md text-[2em] shadow-[2px_2px_5px_3px_rgba(0,0,0,0.5)]" onClick={() => ans(false)}>No</button>
                </div>
